...
const TestDealAnalyserForm = () => {
  const [openSections, setOpenSections] = useState({
    ...
    buyingTransactionsCosts: false,
    profits: false,
    sellingTransactionsCosts: false,
    purchaseDealAnalysis: false,
    potentialReturnProfitAnalysis: false,
  });
  ...
  const [formData, setFormData] = useState({
    ...
    titleInsuranceSearchCostsPercentage: 1,
    miscBuyingCostsPerc: 2,
    ...
    <div className="p-4">
      ...
      <div className="grid grid-cols-2 gap-8">
                ...
                <div className="column-1">
                  <div className="form-group">
                    ...
                    <input
                      ...
                      ref={addressInputRef}
                      className="text-text bg-blue-100 w-full max-w-2xl col-span-2"
                    />
                  </div>
                  <div className="form-group">
        ...
        <div>
          ...
          >
            <h2 className="text-2xl font-semibold mb-4">Holding Costs</h2>
        ...
        <div>
          ...
          >
            <h2 className="text-2xl font-semibold mb-4">Financing Costs</h2>
        ...
        <div>
          ...
          {openSections.profits && (
            <div className="mb-8">
              ...
              <div className="form-group text-green-400 text-2xl my-4">
            ...
            <div className="mb-8">
              ...
              <div className="">
                ...
                <div className="form-group">
                  ...
                  <div className="calculated-field">
                    {formatCurrency(
                      (formData.afterRepairValue * formData.realtorFeePercent) /
                        100
                    )}
                  </div>
                </div>
        ...
        <div>
          ...
          >
            <h2 className="text-2xl font-semibold mb-4">Deal Analysis</h2>
          ...
          {openSections.purchaseDealAnalysis && (
            <div className="my-8">
              ...
              <div className="">
                <div className="form-group text-yellow-100">
                ...
                <div className="form-group text-yellow-100">
                  <label htmlFor="estRepairCosts">ESTIMATED REPAIR COSTS</label>
                  <div className="calculated-field">
                ...
                <div className="form-group text-yellow-100">
                  <label htmlFor="totalHoldingCosts">TOTAL HOLDING COSTS</label>
                  <div className="calculated-field">
                    {formatCurrency(
                      (formData.propertyTaxesAnnually / 12 +
                        formData.hoaAndCondoFeesMonthly +
